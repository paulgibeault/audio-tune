...
// Published, deliberately not precached: the licence text. The fleet manifest
// IS precached — the board must know the pack list offline even though the
// packs themselves live under other apps' scopes and are never cached here.
