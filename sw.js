 ...
 *     navigator.serviceWorker.register('sw.js', { scope: '/audio-tune/' });
 *   }
 *
 ...
 *
 *   1. Never serve or cache anything outside /audio-tune/. The fetch
...
const GAME_ID = 'audio-tune';          // must match Arcade.init({ gameId })
const SCOPE = `/${GAME_ID}/`;
